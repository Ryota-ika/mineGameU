...
public class RandomMine : MonoBehaviour {
    ...
    public float xMinPosition = 0;
    public float xMaxPosition = 10;
    public float yMinPosition = 0;
    public float yMaxPosition = 10;
    ...
    void Awake( ) {
        ...
        //        }
        //        numbers.RemoveAt( rand_x );
        //        numbers.RemoveAt( rand_y );
        //    }
        //for( int i = 0; i < input_mine_count; i++ ) {
        //    int rand_x=Random.Range(0,10);
        //    int rand_y=Random.Range(0,10);
